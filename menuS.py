...
BACKGROUND_AREA = pygame.image.load('img/area.jpg')
BACKGROUND_MENU = pygame.image.load('img/bk.jpeg')
...
def main():
    ...
    # Initial hero
    hero = Sprite(250, 350, 'sprites/player5.png') 
    # Initial target
    ...
    # create Menu
    punkts = [
    (280, 200, u'Play', (0, 0, 255), (250, 30, 250), 0),
    (280, 260, u'Exit', (0, 0, 255), (250, 30, 250), 1)
    ]
    game = Menu(punkts)
    game.menu()
    ...
    while done:
        ...
        for e in pygame.event.get():
            ...
            if e.type == pygame.MOUSEMOTION:
                ...
                if m[0] > 0 and m[0] < board_width:
                    hero.x = m[0]
                if m[1] > 200 and m[1] < board_heigth - 100:
                     hero.y = m[1]
        ...
        screen.blit(BACKGROUND_AREA, (0, 0))
        ...
        # rendering fonts
        info_string.blit(speed_font.render(u'Speed :'+str(target.step), 1, (210, 120, 200)), (470, 5))
        info_string.blit(label_font.render(u'Basketball', 1, (255, sniper_color, 0)), (250, 5))
        info_string.blit(inf_font.render(u'Hit:'+str(hit), 1, (0, 250, 200)), (10, 5) )
        info_string.blit(inf_font.render(u'Miss:'+str(miss), 1, (0, 250, 200)), (70, 5) )
        # view screen
